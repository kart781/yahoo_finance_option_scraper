...
email_list = ["karthikram781@gmail.com"]
...
def send_emails(email_list):
    ...
    for person in email_list:
        ...
        body = f"""Contains the Required Option from Apple, Meta, Tesla, Google, Amazon according to the Regular Market Price"""
        ...
        path = r'C:\Users\karth\yahoo-finance-scraper'
        extension = 'csv'
        os.chdir(path)
