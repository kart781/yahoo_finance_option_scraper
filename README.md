...
A new addition to the tool is the trigger.py script. This script monitors the implied volatility difference for your selected stock ticker symbols. When the difference exceeds a specified limit, the script will cast an email spell, alerting you to the significant change.
<br />
